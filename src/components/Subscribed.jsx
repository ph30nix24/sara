...
const Subscribed = () => {
  return (
    <div className='w-full h-fit md:h-fit' id='subscribed'>
        ...
        <p className='px-4 md:px-0 text-lg md:text-xl text-center pt-2 md:pt-5 pb-10 tracking-wide'>Promotion of new products and sales. Directly to you</p>
        <div className='w-full h-fit element-center md:pl-5'>
            <input type="text" name="email" id="" className='md:w-3/10 w-3/5 md:h-14 h-9 bg-gray-200 px-5 outline-none' placeholder='Enter your email' />
            <Button heading={'subscribe'} bgColor={'bg-primary'} />
        </div>
        <div className='w-full h-fit element-center gap-[5%] md:px-40 md:pt-50 py-10'>
