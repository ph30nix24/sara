  ...
  return (
    <div className='w-full md:h-[500px] h-[320px] relative'>
        ...
        <div className='relative z-30 w-full h-full element-center flex-col'>
            <h1 className='text-4xl md:text-5xl font-semibold text-white uppercase tracking-wide md:pb-2'>Special offer</h1>
            <p className='text-lg md:text-lg text-center text-white pt-2 md:tracking-wider md:word-spacing-wide md:pb-20 pb-10'>Special offers discounts for women this week only</p>
